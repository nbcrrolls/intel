...
function print_help()
{
    ...
    echo ""
    echo "Copyright 2006-2015, Intel Corporation, All Rights Reserved."
}

# ---------------------------------------
#THIS_PACKAGEID=l_cprof_b_11.1.044
THIS_PACKAGEID="composer_xe_2015.3.187"
EULA="license.txt"
RELEASE_NUM=$(echo $THIS_PACKAGEID | cut -f3 -d ".")

INSTALL_PATH="$HOME"

PACKAGE="composer_xe_2015.3.187"
...
echo "Purpose: Intel(R) Parallel Studio XE Update 3 Composer Edition for Fortran Linux* Redistribution Content"
